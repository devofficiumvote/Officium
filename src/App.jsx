    ...
    <div style={{background:"linear-gradient(135deg,#1e1b4b,#020617)",padding:"60px 0"}}>
      <CW>
        <div style={{textAlign:"center",marginBottom:32}}>
          ...
          <LastUpdated/>
          <p style={{fontSize:13,color:"rgba(255,255,255,.35)",margin:"8px 0 0",lineHeight:1.5}}>Patterns and correlations discovered by cross-referencing FEC, trade, and lobbying data.</p>
        </div>
        <div style={{display:"grid",gridTemplateColumns:m?"1fr":"repeat(auto-fill,minmax(300px,1fr))",gap:16}}>
          {insights.map((ins,i)=>(
            <div key={i} style={{background:"rgba(99,102,241,.04)",border:"1px solid rgba(99,102,241,.12)",borderRadius:16,padding:22,position:"relative",overflow:"hidden",transition:"border-color .2s,transform .2s"}} onMouseEnter={e=>{e.currentTarget.style.borderColor="rgba(99,102,241,.3)";e.currentTarget.style.transform="translateY(-2px)";}} onMouseLeave={e=>{e.currentTarget.style.borderColor="rgba(99,102,241,.12)";e.currentTarget.style.transform="none";}}>
